...
namespace MovieRecommenderGrpcService.Services
{
    public class MovieRecommenderService : MovieRecommender.MovieRecommenderBase
    {
        ...
        public override Task<RecommendationReply> Recommend(RecommendationRequest request, ServerCallContext context)
        {
            ...
            if (score >= 4.0f)
            {
                explanationMessage = "Highly recommended";
            }
            else if (score >= 3.5f)
            {
                explanationMessage = "Recommended";
            }
            else if (score >= 2.0f)
            {
                explanationMessage = "Neutral";
            }
            else
            {
                explanationMessage = "Not recommended";
            }
